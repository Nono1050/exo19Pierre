...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../dossierCss/style.css">
	<script src="https://kit.fontawesome.com/a62a90acc1.js" crossorigin="anonymous"></script>
</head>
<body>
	<section class="nav-bar">

		<a href="./"><img src="../img/images/logo-cf.png" class="logo"></a>
		
		<?php
		include 'inc/navbarView.php';
		?>
...
<!--Section header -->
	<section class="header">
		...
		<a href="../../view/formations.php" class="btn">Nos formations</a>
	</section>
	...
	<section class="formations">
		...
		<div class="row">
			...
			<div class="formations-col">
				<img src="../img/images/html-css.jpg">
				...
				<a href='../../view/formations.php'class="btn-formation">Découvrir la formation</a>
			</div>


			<div class="formations-col">
				<img src="../img/images/php.jpg">
				<div class="prix">199.99€</div>
				<h3>PHP</h3>
				<p>Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression. Le Lorem Ipsum est le faux texte standard de l'imprimerie depuis les années 1500</p>
			...
			<div class="formations-col">
				<img src="../img/images/javascript.jpg">
				<div class="prix">199.99€</div>
				<h3>JavaScript</h3>
				<p>Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression. Le Lorem Ipsum est le faux texte standard de l'imprimerie depuis les années 1500</p>
		...
		<div class="row">
			...
			<div class="formations-col">
				<img src="../img/images/data-science.jpg">
				<div class="prix">199.99€</div>
				<h3>Data Science</h3>
				<p>Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression. Le Lorem Ipsum est le faux texte standard de l'imprimerie depuis les années 1500</p>
			...
			<div class="formations-col">
				<img src="../img/images/php-poo.jpg">
				<div class="prix">199.99€</div>
...
<!-- ---------------Section A propos ------------------>
	<section class="apropos">
		<div>
			...
			<a href='../../view/formations.php' class="btn">En savoir Plus</a>
		...
		<div id="nos-services">
			...
			<div class="row-services">
				...
				<div class="nos-services-col">
					<img src="../img/images/qualite.png">
					<div>
				...
				<div class="nos-services-col">
					<img src="../img/images/competences.png">
					<div>
			...
			<div class="row-services">
				...
				<div class="nos-services-col">
					<img src="../img/images/soutien.png">
					<div>
				...
				<div class="nos-services-col">
					<img src="../img/images/exactitude.png">
					<div>
...
<!-- -----------Section devenir formateur --------------->
	<section class="devenir-formateur">
		<div class="text-bloc">
			...
			<a href='../../view/formations.php'><button class="btn-formateur">Devenir Formateur</button></a>
...
<!-- -----------------Section les avis des utilisateurs -------->
	...
	<section class="container-avis">
		...
		<div class="row-avis">
			...
			<div class="col-avis">
				<img src="img/images/utilisateur.png">
				<p>Le cours HTML-CSS-PHP aborde toutes les notions nécessaires à la compréhension du PHP. Parfait, pour ne pas dire excellent… Merci</p>
				<h4>Amine Kara</h4>
				<div class="star">
					<i class="fa-solid fa-star"></i>
...
<footer>
	...
	<?php
	include '../../view/inc/footerview.php';
	?>
